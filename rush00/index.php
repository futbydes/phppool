...
?>
    ...
    <div id="sidebar">
        ...
        <p class="submit"><input type="button" value="Go to cart" onclick="window.location.href='cart.php'"/></p>
		...
		<ul class="menu" style="position: absolute; margin-left: 70%;">
		<?php
		...
		$res = mysqli_query($con, "SELECT * FROM products ORDER BY price");
		echo "<table style='float: left; font-size: 18; font-weight: bold; max-width: 70%; min-height: 10vmin; width: 100%; text-align: center; margin-bottom: 5vmin;'>";
		$i = 0;
		while($row = mysqli_fetch_assoc($res))
		{
			if( $i % 4 == 0 ) 
